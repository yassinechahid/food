...
export default function EventsPage() {
  ...
  const events = [
    ...
    },
    {
      ...
      description:
        "Contemporary cocktail reception with innovative small plates",
    },
    {
    ...
    <main className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-rose-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section className="relative pt-32 pb-10 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          {/* Category Filter */}
          <div className="flex items-center gap-2 p-2 rounded-full bg-white dark:bg-gray-800 shadow-lg max-w-full">
            <Filter className="w-5 h-5 text-gray-600 dark:text-gray-400 ml-2 flex-shrink-0" />
            <div className="flex gap-2 overflow-x-auto scrollbar-hide">
              {categories.map((category) => (
                <button
                  key={category}
                  onClick={() => setSelectedCategory(category)}
                  className={`px-6 py-3 rounded-full font-medium transition-all duration-300 capitalize whitespace-nowrap ${
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredEvents.map((event, index) => (
              <div
                ...
                <div className="relative h-64 overflow-hidden bg-gradient-to-br from-amber-100 to-rose-100 dark:from-amber-900/20 dark:to-rose-900/20">
                  {!imageErrors[index] ? (
                    <Image
                      src={event.image}
                      alt={event.title}
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-amber-200 to-rose-200 dark:from-amber-800 dark:to-rose-800">
                      <div className="text-center p-6">
                        <Calendar className="w-16 h-16 mx-auto mb-2 text-amber-600 dark:text-amber-400 opacity-50" />
          ...
          <div className="relative">
            ...
            <div className="relative rounded-3xl p-12 bg-gradient-to-br from-amber-600 to-rose-600 text-white text-center">
              ...
              <p className="text-xl mb-8 opacity-90">
                {"Let's"} bring your vision to life with our exceptional
                catering and planning services
              </p>
